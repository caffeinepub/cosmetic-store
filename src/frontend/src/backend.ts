...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: Category, arg3: string, arg4: number, arg5: string, arg6: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addProduct(arg0, arg1, to_candid_Category_n1(this._uploadFile, this._downloadFile, arg2), arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async filterByCategory(arg0: Category): Promise<Array<Product>> {
        if (this.processError) {
            try {
    ...
    async getCallerWishlist(): Promise<Array<Product>> {
        if (this.processError) {
            try {
    ...
    async getProductsSortedByPrice(arg0: boolean): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductsSortedByPrice(arg0);
                return from_candid_vec_n5(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isProductInWishlist(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: Category, arg4: string, arg5: number, arg6: string, arg7: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProduct(arg0, arg1, arg2, to_candid_Category_n1(this._uploadFile, this._downloadFile, arg3), arg4, arg5, arg6, arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "fragrance" in value ? Category.fragrance : "skincare" in value ? Category.skincare : "makeup" in value ? Category.makeup : "bodycare" in value ? Category.bodycare : "haircare" in value ? Category.haircare : value;
}
